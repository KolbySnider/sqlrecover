...
/// scanner, which doesn't have a cell envelope to lean on: TEXT columns
/// need to be mostly printable, and the row can't be entirely NULL (very
/// common over zeroed regions).
/// @param vals Decoded values to inspect.
