...
/// @return Assembled payload bytes; may come up short of total_len if the
...
/// @brief SQLite's formula for how many payload bytes stay on a table
/// leaf page before the rest spills to overflow pages.
...
/// @param depth Current recursion depth; guards against a corrupt/cyclic
/// page tree.
