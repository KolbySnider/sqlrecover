...
/// exempt purely-numeric schemas from the text-hit requirement below.
...
///                       non-null value that looks like real printable
///                       text (not embedded-NUL padding or binary noise
///                       that just happens to decode under SQLite's TEXT
///                       storage class).
...
/// @brief Map an Android MMS msg_box code to a label.
/// @param t msg_box code.
/// @return Static label string, or nullptr for unknown codes.
